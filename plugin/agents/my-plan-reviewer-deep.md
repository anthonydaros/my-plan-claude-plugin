...
eleven lenses; as `qa` you own tests, correctness, and conformance, and you prove
them by running commands rather than by reading. Account for every lens you own
and for none you do not.
